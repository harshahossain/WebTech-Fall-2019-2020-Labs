		...
		<form action="" method="post">
			<fieldset>
				...
				<table>
					...
					<tr>
						<td align="right">Phone:</td>
					<td><input type="text" name="" size="4" placeholder="code"><strong>  -  	</strong><input type="text" name=""size="9" placeholder="Number"></td>
					</tr>
					<tr>
						<td align="right">Address:</td>
						<td><input type="text" name="address" placeholder="Street Address"> <br>
...
>>>>>>> 9fa3e8be3da3484e177ebd6ed3a17582cc37680b
</html>